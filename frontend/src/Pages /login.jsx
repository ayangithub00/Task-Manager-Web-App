    ...
    <div className="min-h-screen flex items-center justify-center p-8 bg-slate-50">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <span className="text-xl font-semibold text-slate-900">Brand</span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            type="button"
            className="h-12 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-900 font-medium flex items-center justify-center gap-2 transition-colors"
          >
